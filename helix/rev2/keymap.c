...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Alt  | GUI  | ESC  | Raise| EISU |Space | TAB  | Lower|Enter | Bksp |  Up  | ESC  | Alt  | Del  |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_LALT, KC_LGUI, KC_ESC,  RAISE,   EISU,    KC_SPC,  KC_TAB,  KC_BSPC, KC_ENT,  LOWER,   KC_UP,   KC_ESC,  KC_RALT, KC_DEL \
      ),
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      | BTN4 | MsUp | BTN5 |      |             |      | Home | End  |      |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |MsLeft|MsDown|MsRght|      |             | Left | Down |  Up  | Ritht|      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      | DEL  |      |      |      |      |      |      |WhDown| WhUp |      |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      | Lclk | Rclk |      |      |      |      |      |      |      |
  ...
  [_LOWER] = KEYMAP( \
      ...
      _______, _______, KC_BTN4, KC_MS_U, KC_BTN5, _______,                   _______, KC_HOME, KC_END,  _______, _______, _______, \
      _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
      _______, _______, KC_DEL,  _______, _______, _______, _______, _______, _______, KC_WH_D, KC_WH_U, _______, _______, _______, \
