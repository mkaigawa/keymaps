...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | LGui |   Q  |   W  |   E  |   R  |   T  |  ESC |                    |   =  |   Y  |   U  |   I  |   O  |   P  |  \   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Ctrl |   A  |   S  |   D  |   F  |   G  |   [  |                    |   ]  |   H  |   J  |   K  |   L  |   ;  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      |                    |      |   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | Alt  |  Up  | Down | EISU |||||||| Space| Tab  |      ||||||||      | Enter| Bksp |||||||| Lower| Left | Right|  Alt |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_ESC,                         KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
    KC_LGUI, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_ESC,                         KC_EQL , KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
    ...
    KC_LALT, KC_UP,   KC_DOWN, EISU,             KC_SPC,  KC_TAB ,_______,        _______,KC_ENT , KC_BSPC,          LOWER,   KC_LEFT, KC_RGHT, KC_RALT    \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS, KC_TRNS, \
